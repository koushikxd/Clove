    ...
    <div className="flex min-h-svh items-center justify-center p-4">
      <Card className="w-full max-w-sm">
        <CardHeader>
          ...
          <CardDescription>
            {candidateAllowed
              ? "Use the invited email to continue as a candidate, or switch back to recruiter sign in."
              : candidatePending
        ...
        <form onSubmit={handleSubmit}>
          ...
          <CardFooter className="mt-2 flex flex-col gap-3">
            ...
            <p className="text-center text-sm text-muted-foreground">
              ...
              <Link
                href={`/signup?role=${selectedRole}${effectiveEmail ? `&email=${encodeURIComponent(effectiveEmail)}` : ""}${searchParams.get("invite") ? `&invite=${searchParams.get("invite")}` : ""}`}
